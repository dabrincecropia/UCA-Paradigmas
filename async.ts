...
function obtenerAreaCuadrado(lado:number):number{
    return lado * lado;
...
function obtenerPerimetroRectangulo(largo:number,ancho:number):number{
...
function obtenerAreaTriangulo(base:number,altura:number):number{
...
function obtenerLongitudCircunferenciaCirculo(radio:number):number{
    return 2 * PI * radio;
...
/* Apartado de funciones a realizar para Mostrar el calculo de las áreas y perimetros solicitados */
 /* Está función es realizada con el objetivo de mostrar el resultado del área de un cuadrado, en este
    ...
    function mostrarResultadoCuadrado():void{
...
/* Está función es realizada con el objetivo de mostrar el resultado del perimetro de rectangulo, en este
    ...
    function mostrarResultadoRectangulo():void{
...
/* Está función es realizada con el objetivo de mostrar el resultado del área de un triangulo, en este
    ...
    function mostrarResultadoTriangulo():void{
...
*/
    function mostrarResultadosLongitudCircunferencia():void{
...
*/
 function mostrarResultadosAreaCircunferencia():void{
